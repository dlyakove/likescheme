...
const f = {
  ...
  'false': () => false,
  'null': () => null,
  'isundefined': (l, data) => (g(l[0], data) === undefined),
  ...
  'and': (l) => l.every(v => v),
  'not': (l) => !l[0],
  'isy': (l, data) => f.in([f.low([f.var(l, data)]), ['yes', 'y', 'true']]),
  'isyu': (l, data) => f.in([f.low([f.var(l, data)]), ['yes', 'y', 'na', 'true']]),
  'isn': (l, data) => f.in([f.low([f.var(l, data)]), ['n', 'no', 'false']]),
  'isnu': (l, data) => f.in([f.low([f.var(l, data)]), ['n', 'no', 'na', 'false']]),
